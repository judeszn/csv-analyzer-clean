...
class UniversalFileProcessor:
    ...
    def validate_file(self, uploaded_file, file_type: str) -> Tuple[bool, str]:
        ...
        max_size = self.MAX_FILE_SIZES.get(file_type, 1024*1024)  # Default 1MB
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    raise Exception(f"Failed to extract text with both methods. pdfplumber: {pdfplumber_error}, PyPDF2: {pypdf2_error}")
            finally:
                # Clean up temp file
                try:
